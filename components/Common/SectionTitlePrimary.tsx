  ...
  return (
    <>
      ...
      >
        ...
        >
          <h2 className="mb-4 text-2xl font-semibold !leading-tight text-black/90 hover:text-primary dark:text-white dark:hover:text-primary sm:text-4xl md:text-4xl">
            {title}
          </h2>
