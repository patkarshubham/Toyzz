...
const BreadcrumbDemoTitle = ({
  ...
  return (
    <section id={anchorId} className="relative z-10 overflow-hidden ">
      <div className="mx-auto flex flex-col items-center justify-center pt-[180px] text-center lg:pt-[180px] xl:pt-[180px]">
...
export default BreadcrumbDemoTitle;
