...
const Breadcrumb = ({
  ...
  return (
    <section className="relative z-10 overflow-hidden pt-28 md:pt-[150px] lg:pt-[130px] xl:pt-[130px]">
      <div className="container mx-auto flex flex-col items-center text-center">
        <div className="w-full px-4">
          <div className="mx-auto mb-5 max-w-[870px]">
            ...
            <p className="mb-20 text-base leading-relaxed text-black/70 dark:text-white/90 md:text-lg">
              {description}
            </p>
          </div>
        </div>
